    ...
    const dialogRef = this.dialog.open(WTimeDialogComponent, {
      data: {
        time: {
          ...
          minute: this.timepicker.userTime
            ? this.timepicker.userTime.minute
            : 0,
          meriden: this.timepicker.userTime
            ? this.timepicker.userTime.meriden
            : 'PM',
          format: this.timepicker.userTime
            ? this.timepicker.userTime.format
            : 12
        },
